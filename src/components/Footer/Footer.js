...
const Footer = () => {
  return (
    <div className="grid grid-rows-1 grid-cols-5 w-3/4 justify-center items-center m-auto text-gray-300 text-sm mt-32 pb-14 md:pb-12 sm:grid-rows-5 sm:grid-cols-1 sm:bg-red-500 sm:bg-opacity-20 sm:pb-10 sm:pt-8 sm:rounded-t-2xl sm:gap-1 sm:text-base">
