...
const Footer = () => {
  return (
    <div className="flex-row w-full h-12 absolute bottom-1 text-gray-400 justify-center items-center text-sm">
      <div className="inline-block ml-36"><FaRegCopyright className="inline-block pr-1"/>2021-All Rights Reserved</div>
      <div className="inline-block ml-96 absolute right-44">
