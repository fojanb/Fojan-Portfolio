...
const Home = () => {
  return (
    <div className="grid grid-rows-1 grid-cols-2 w-2/3 pt-24 justify-center items-center m-0 m-auto gap-4 lg:grid-cols-1 md:px-14 sm:px-8 sm:m-auto md:mb-28 lg:gap-8">
