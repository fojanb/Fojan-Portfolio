...
const NavBar = () => {
  return (
    <div id="navbar" className="grid grid-rows-1 grid-cols-4 justify-center text-lg items-center bg-red-500 bg-opacity-20 rounded-b-2xl py-8 w-1/2 text-gray-100 m-auto lg:w-3/4 md:w-3/4 sm:grid-cols-1 sm:gap-4 sm:bg-red-500 sm:bg-opacity-20 sm:pb-10 sm:rounded-b-2xl">
