...
const Main = () => {
  return (
    <div className="grid grid-rows-2 grid-cols-1 justify-center items-center m-auto px-28 md:px-14 sm:px-8 sm:m-auto">
      <div className="flex flex-col text-5xl text-gray-100 font-bold pt-24 lg:text-4xl md:text-3xl md:pt-14 galaxy:text-3xl sm:text-xl sm:m-auto sm:justify-center sm:items-center sm:">
        <h1>SARAH NILSON</h1>
      ...
      <div className="flex flex-wrap text-gray-100 md:justify-evenly galaxy:justify-evenly sm:justify-evenly">
