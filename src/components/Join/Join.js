...
const Join = () => {
    return (
        <form action="" className="grid grid-cols-1 m-auto w-80 mt-20 gap-8 bg-red-500 bg-opacity-20 p-12">
            ...
            <button type="submit" className="bg-ruby font-bold border rounded m-auto text-lg px-8 py-2 text-gray-100 transform hover:scale-110 hover:transition duration-500 ease-in-out sm:text-sm sm:w-40 sm:h-10 sm:mb-5">Submit</button>
        </form>
    )
}
