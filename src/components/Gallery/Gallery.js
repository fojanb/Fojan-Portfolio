...
const Gallery = () => {
  return (
    <div className="pb-36">
      ...
      <div className="grid grid-rows-2 grid-cols-3 gap-8 text-gray-100 w-3/4 m-auto py-8 lg:w-3/4 md:grid-cols-1 md:w-1/2 galaxy:w-1/2 sm:grid-cols-1 sm:gap-4">
