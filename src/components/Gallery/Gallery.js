...
const Gallery = () => {
  return (
    <div>
      ...
      <p className="bg-blob2 bg-contain bg-center bg-no-repeat flex text-left items-center justify-center text-gray-100 font-bold text-3xl py-8 mt-8 sm:bg-red-500 sm:bg-opacity-20 sm:w-5/6 sm:m-auto sm:rounded-2xl sm:mt-8 sm:p-2 sm:text-sm sm:bg-none md:bg-red-500 md:bg-opacity-20 md:w-5/6 md:m-auto md:mt-8 md:rounded-2xl md:p-2 md:text-xl md:bg-none">Gallery</p>
