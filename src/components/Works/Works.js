...
const Works = () => {
  return (
    <div className="grid grid-cols-1 grid-rows-1 pb-36 m-0 m-auto">
      ...
      <div className="grid grid-rows-1 grid-cols-3 gap-8 text-gray-100 w-1/2  m-auto py-8 lg:w-3/4 md:grid-cols-1 md:w-1/2 galaxy:w-3/4 sm:grid-cols-1 sm:gap-4 ">
