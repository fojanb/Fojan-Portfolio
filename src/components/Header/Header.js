  ...
  return (
    <>
      ...
      <div className="flex-row absolute right-0 pl-20 justify-center items-center mr-24 ">
        ...
        <div className="inline-block m-8 text-gray-300 font-bold text-base xl:m-8 lg:m-1 lg:p-2 lgg:m-1 lgg:p-4 sm:text-xs sm:m-1 sm:p-4">
          Gallery
        </div>
        <div className="inline-block m-8 text-gray-300 font-bold text-base xl:m-8 lg:m-1 lg:p-2 lgg:m-1 lgg-p4 sm:text-xs sm:m-1 sm:p-4">
          About
        </div>
        <div className="inline-block m-8 text-gray-300 font-bold text-base xl:m-8 lg:m-1 lg:p-2 lgg:m-1 lgg:p-4 sm:text-xs sm:m-1 sm:p-4">
          Contact
