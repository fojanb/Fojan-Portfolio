    ...
    <div>
      ...
      <div className="grid grid-rows-1 grid-cols-2 text-gray-100 w-5/6 m-auto py-8">
        <form action="" method="POST" className="grid grid-rows-6 grid-cols-1 gap-4 m-auto">
          <input type="text" className="flex pl-2" placeholder="First Name" name="fname" />
          <input type="text" className="flex pl-2" placeholder="Last Name" name="lname" />
          <input type="email" className="flex pl-2" placeholder="Email" name="email"/>
          <input type="password" className="flex pl-2" placeholder="Password" name="password"/>
